 ...
 *
 * Derived from hurryman2212/rtk-rtl8261ce-phy. This copy is not the upstream
 * file: the LED controls were reverse-engineered separately for the W1700K
 * device tree, RTL8261C support follows the cmonroe/target-airoha patches
 * (992-08-01, 992-08-02), and two 6.12 adaptations replace APIs that kernel
 * lacks. The recovered register sequences are unchanged; see the git history
 * of this tree for the differences.
 */
